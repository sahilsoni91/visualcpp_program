...
NewFileInclude2=#include "four.h"
LastPage=0
...
Type=0
HeaderFile=four.h
ImplementationFile=four.cpp
Filter=N

[CLS:CFourDoc]
Type=0
HeaderFile=fourDoc.h
ImplementationFile=fourDoc.cpp
Filter=N

[CLS:CFourView]
Type=0
HeaderFile=fourView.h
ImplementationFile=fourView.cpp
Filter=C
