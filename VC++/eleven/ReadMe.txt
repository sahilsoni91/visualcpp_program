========================================================================
		ActiveX Control DLL : ELEVEN
========================================================================

ControlWizard has created this project for your ELEVEN ActiveX Control
...
that make up your ELEVEN ActiveX Control DLL.
...
ElevenCtl.h
	This file contains the declaration of the CElevenCtrl C++ class.

ElevenCtl.cpp
	This file contains the implementation of the CElevenCtrl C++ class.

ElevenPpg.h
	This file contains the declaration of the CElevenPropPage C++ class.

ElevenPpg.cpp
	This file contains the implementation of the CElevenPropPage C++ class.

ElevenCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CElevenCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file eleven.rc.
